...
if __name__ == "__main__":
    ...
    outputPaths = [f"{config.tildeThBuoyancyPath}{caseName}/gaussian-{std}/" for std in stdList]
    tildeWriters = [DataWriter(op) for op in outputPaths]
    outputPaths = [f"{config.perturbThBuoyancyPath}{caseName}/gaussian-{std}/" for std in stdList]
