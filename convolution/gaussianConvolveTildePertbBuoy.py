...
if __name__ == "__main__":
    ...
    outputPaths = [f"{config.tildeBuoyancyPath}{caseName}/gaussian-{std}/" for std in stdList]
    tildeWriters = [DataWriter(op) for op in outputPaths]
    outputPaths = [f"{config.perturbBuoyancyPath}{caseName}/gaussian-{std}/" for std in stdList]
