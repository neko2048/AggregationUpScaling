...
class VVMLoader:
    def __init__(self, dataDir, subName="exp"):
        ...
        self.headLineIdxOfZZ = 187 - 1
        self.headLineIdxOfRho = 236 - 1
        self.headLineIdxOfRhoz = 334 - 1
        if "RCE" in self.dataDir or "rce" in self.dataDir:
            self.headLineIdxOfRho = 266 - 1
